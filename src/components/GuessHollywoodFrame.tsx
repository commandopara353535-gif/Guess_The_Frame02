...
const hollywoodFrames = [
  { id: 1, image: '/frames/hollywood/frame1.jpg', answer: 'Hollywood Movie 1' },
  { id: 2, image: '/frames/hollywood/frame2.jpg', answer: 'Hollywood Movie 2' },
  { id: 3, image: '/frames/hollywood/frame3.jpg', answer: 'Hollywood Movie 3' },
  { id: 4, image: '/frames/hollywood/frame4.jpg', answer: 'Hollywood Movie 4' },
  { id: 5, image: '/frames/hollywood/frame5.jpg', answer: 'Hollywood Movie 5' },
  { id: 6, image: '/frames/hollywood/frame6.jpg', answer: 'Hollywood Movie 6' },
  { id: 7, image: '/frames/hollywood/frame7.jpg', answer: 'Hollywood Movie 7' },
  { id: 8, image: '/frames/hollywood/frame8.jpg', answer: 'Hollywood Movie 8' },
  { id: 9, image: '/frames/hollywood/frame9.jpg', answer: 'Hollywood Movie 9' },
  { id: 10, image: '/frames/hollywood/frame10.jpg', answer: 'Hollywood Movie 10' },
  { id: 11, image: '/frames/hollywood/frame11.jpg', answer: 'Hollywood Movie 11' },
];
      ...
      <div className="bg-white rounded-lg shadow-xl p-6">
        ...
        <div className="relative aspect-video bg-gray-900 rounded-lg overflow-hidden mb-6">
          <img
            ...
            onError={(e) => {
              e.currentTarget.src = 'https://images.pexels.com/photos/7991158/pexels-photo-7991158.jpeg?auto=compress&cs=tinysrgb&w=800';
            }}
          />
          {showAnswer && (
        ...
        <div className="flex items-center justify-between gap-4 mb-6">
          ...
          <div className="text-center">
            <span className="text-sm text-gray-500">
              Frame {currentIndex + 1} of {hollywoodFrames.length}
            </span>
          </div>
          ...
          <button
            onClick={handleNext}
            disabled={currentIndex === hollywoodFrames.length - 1}
